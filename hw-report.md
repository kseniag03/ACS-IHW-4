...
2. Приведены входные и выходные файлы с различными результатами выполнения программы ([tests](https://github.com/kseniag03/ACS-IHW-4/tree/main/test))
3. В ввод данных из командной строки добавлена возможность выбрать опцию с генерацией (файловый ввод доступен при option = all \ {1, 2, 3})
...
При замене мьютексов на одни лишь семафоры <br>
